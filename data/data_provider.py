...
from ..common.exceptions import InsufficientDataError, NetworkError, DataError
...
class MarketDataProvider:
    def __init__(
        ...
        self.binance_fetcher = binance_fetcher or BinanceFetcher(
            redis_client=self.redis, session=self.session
        )
    ...
    async def fetch_ohlcv_data(
        ...
        cache_ttl_map = {"1h": 120, "4h": 300, "1d": 600, "1w": 1800, "1M": 3600}
